...
def sidebar(current):
    ...
    lines = [
        '<div class="sidebar">',
        '  <div class="nav-brand"><img class="nav-brand-logo" src="https://upload.wikimedia.org/wikipedia/commons/5/5f/Zebra_Technologies_logo.svg?v=2" alt="Zebra logo" loading="lazy" referrerpolicy="no-referrer" /></div>',
