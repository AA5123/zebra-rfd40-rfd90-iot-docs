    ...
    function injectGroupHeaders(sr) {
      ...
      for (var i = 0; i < navTags.length; i++) {
        ...
        if (firstMap[tagText]) {
          ...
          hdr.style.cssText = 'font-size:12px;font-weight:700;color:#003d6b;text-transform:uppercase;letter-spacing:1.5px;padding:' + (isFirst ? '8px' : '14px') + ' 16px 6px;' + (isFirst ? '' : 'margin-top:4px;border-top:1.5px solid #d0d5dd;');
