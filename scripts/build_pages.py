    ...
    function injectGroupHeaders(sr) {
      ...
      for (var i = 0; i < navTags.length; i++) {
        ...
        if (firstMap[tagText]) {
          ...
          hdr.style.cssText = 'font-size:15px;font-weight:800;color:#003d6b;text-transform:uppercase;letter-spacing:1.5px;padding:' + (isFirst ? '10px' : '16px') + ' 16px 8px;' + (isFirst ? '' : 'margin-top:6px;border-top:2px solid #003d6b;');
