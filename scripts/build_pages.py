...
<body>
  ...
  (function() {
    ...
    mqttSheet.replaceSync([
      ...
      'th { background: #003d6b !important; color: #fff !important; font-weight: 600 !important; font-size: 18px !important; letter-spacing: 0.3px !important; padding: 11px 14px !important; text-align: left !important; border-color: #002d50 !important; }',
      'td { padding: 10px 14px !important; vertical-align: top !important; font-size: 18px !important; border: 1px solid #8a94a6 !important; word-break: break-word !important; }',
      ...
      '.api-content h2, .section-gap h2, .section-gap--read-mode h2 { color: #003d6b !important; border-bottom: 2px solid #003d6b !important; padding-bottom: 6px !important; margin-top: 28px !important; font-size: 28px !important; }',
      '.api-content h3, .section-gap h3 { color: #003d6b !important; margin-top: 20px !important; font-size: 22px !important; }',

      /* ── Code blocks: match PDF styling ── */
      'pre { background: #f5f5f5 !important; border-left: 4px solid #003d6b !important; border-radius: 4px !important; padding: 14px 16px !important; font-size: 16px !important; line-height: 1.5 !important; max-height: 400px !important; overflow: auto !important; }',
      'code { background: #f4f4f4 !important; border-radius: 3px !important; padding: 1px 6px !important; font-size: 16px !important; color: #1a1a1a !important; }',
      'pre code { background: none !important; border: none !important; padding: 0 !important; font-size: 16px !important; }',

      /* ── Textareas (request bodies) ── */
      'textarea { min-height: 50px !important; max-height: 220px !important; height: auto !important; resize: vertical !important; font-size: 16px !important; padding: 10px !important; }',
      ...
      /* ── Description text ── */
      '.m-markdown p, .m-markdown li { font-size: 20px !important; line-height: 1.6 !important; color: #1a1a1a !important; }',
      '.m-markdown strong { color: #1a1a1a !important; }',

      /* ── Schema table: widen and improve readability ── */
      ':host { --font-size-small: 18px !important; --font-size-regular: 20px !important; --font-size-mono: 16px !important; }',
      ...
      '.request-body-container *, .response-body-container * { --font-size-small: 18px !important; --font-size-regular: 20px !important; }',
