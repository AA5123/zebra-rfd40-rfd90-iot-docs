    ...
    function hideHttpMethods() {
      ...
      if (!style) {
        ...
        style.textContent = [
          ...
          'textarea.request-body-param-user-input { min-height: 60px !important; max-height: 200px !important; height: auto !important; resize: vertical !important; }',
          '.example-panel pre { margin: 0 !important; padding: 8px 12px !important; }',
          '.example-panel { margin-bottom: 8px !important; }',
          '.json { max-height: 300px !important; overflow: auto !important; }',
          'pre { max-height: 300px !important; overflow: auto !important; }',
        ].join('\\n');
    ...
    function addCopyButtons() {
      ...
      for (var i = 0; i < pres.length; i++) {
        ...
        btn.addEventListener('click', (function(target) {
          return function() {
            var text = target.textContent.replace(/^Copy/, '').trim();
