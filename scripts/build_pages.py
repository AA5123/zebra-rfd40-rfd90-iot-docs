...
<body>
  ...
  (function() {
    ...
    mqttSheet.replaceSync([
      ...
      '.api-content h2, .section-gap h2, .section-gap--read-mode h2 { color: #003d6b !important; border-bottom: 2px solid #003d6b !important; padding-bottom: 6px !important; margin-top: 28px !important; font-size: 22px !important; }',
      '.api-content h3, .section-gap h3 { color: #003d6b !important; margin-top: 20px !important; font-size: 18px !important; }',
      ...
      ':host { --font-size-small: 20px !important; --font-size-regular: 20px !important; --font-size-mono: 18px !important; }',
      ...
      '.schema-table .td { padding: 10px 14px !important; font-size: 20px !important; word-break: break-word !important; min-width: 0 !important; }',
      '.schema-table .key { min-width: 140px !important; font-size: 20px !important; }',
      '.schema-table .key-type { min-width: 70px !important; white-space: nowrap !important; font-size: 20px !important; }',
      '.schema-table .key-descr { min-width: 0 !important; flex: 1 !important; font-size: 20px !important; }',
      '.obj-descr { font-size: 20px !important; }',
      '.descr-text { font-size: 20px !important; }',
      'span.descr-text { font-size: 20px !important; }',
      '.schema-description { font-size: 20px !important; }',
      '.toolbar-btn { font-size: 18px !important; }',
      '.request-body-container *, .response-body-container * { --font-size-small: 20px !important; --font-size-regular: 20px !important; }',
