...
<body>
  ...
  (function() {
    ...
    mqttSheet.replaceSync([
      ...
      '.schema-table .key { min-width: 140px !important; }',
      '.schema-table .key-type { min-width: 70px !important; white-space: nowrap !important; }',
      '.schema-table .key-descr { min-width: 0 !important; flex: 1 !important; }',
