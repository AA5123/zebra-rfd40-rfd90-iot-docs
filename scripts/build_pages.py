...
<body>
  ...
  (function() {
    ...
    mqttSheet.replaceSync([
      ...
      'th { background: #003d6b !important; color: #fff !important; font-weight: 600 !important; font-size: 15px !important; letter-spacing: 0.3px !important; padding: 9px 12px !important; text-align: left !important; border-color: #002d50 !important; }',
      'td { padding: 8px 12px !important; vertical-align: top !important; font-size: 15px !important; border: 1px solid #8a94a6 !important; word-break: break-word !important; }',
      'tr:nth-child(odd) td { background: #ffffff !important; }',
      'tr:nth-child(even) td { background: #f7f9fb !important; }',

      /* ── Headings: navy accent ── */
      '.endpoint-body .summary .title, .summary .title, div.summary div.title { font-size: 32px !important; font-weight: 700 !important; color: #003d6b !important; letter-spacing: 0.3px !important; border-bottom: 3px solid #003d6b !important; padding-bottom: 10px !important; display: block !important; margin-bottom: 12px !important; }',
      '.endpoint-head .descr { display: none !important; }',
      '.api-content h2, .section-gap h2, .section-gap--read-mode h2 { color: #003d6b !important; border-bottom: 2px solid #003d6b !important; padding-bottom: 6px !important; margin-top: 28px !important; font-size: 24px !important; }',
      '.api-content h3, .section-gap h3 { color: #003d6b !important; margin-top: 20px !important; font-size: 20px !important; }',

      /* ── Code blocks: match PDF styling ── */
      'pre { background: #f5f5f5 !important; border-left: 4px solid #003d6b !important; border-radius: 4px !important; padding: 12px 14px !important; font-size: 14px !important; line-height: 1.5 !important; max-height: 300px !important; overflow: auto !important; }',
      'code { background: #f4f4f4 !important; border-radius: 3px !important; padding: 1px 5px !important; font-size: 14px !important; color: #1a1a1a !important; }',
      'pre code { background: none !important; border: none !important; padding: 0 !important; font-size: 14px !important; }',

      /* ── Textareas (request bodies) ── */
      'textarea { min-height: 40px !important; max-height: 180px !important; height: auto !important; resize: vertical !important; font-size: 14px !important; padding: 8px !important; }',
      ...
      /* ── Description text ── */
      '.m-markdown p, .m-markdown li { font-size: 16px !important; line-height: 1.6 !important; color: #1a1a1a !important; }',
      '.m-markdown strong { color: #1a1a1a !important; }',

      /* ── Schema table: widen and improve readability ── */
      ':host { --font-size-small: 16px !important; --font-size-regular: 16px !important; --font-size-mono: 14px !important; }',
      ...
      '.schema-table .td { padding: 8px 12px !important; font-size: 16px !important; word-break: break-word !important; min-width: 0 !important; }',
      '.schema-table .key { min-width: 140px !important; font-size: 16px !important; }',
      '.schema-table .key-type { min-width: 70px !important; white-space: nowrap !important; font-size: 16px !important; }',
      '.schema-table .key-descr { min-width: 0 !important; flex: 1 !important; font-size: 16px !important; }',
      '.obj-descr { font-size: 16px !important; }',
      '.descr-text { font-size: 16px !important; }',
      'span.descr-text { font-size: 16px !important; }',
      '.schema-description { font-size: 16px !important; }',
      '.toolbar-btn { font-size: 14px !important; }',
      '.request-body-container *, .response-body-container * { --font-size-small: 16px !important; --font-size-regular: 16px !important; }',
    ...
    function addCopyToElement(root) {
      ...
      /* Style "Allowed:" values as bordered code badges (like Enum display) */
      ...
      for (var a = 0; a < allSpans.length; a++) {
        ...
        var idx = innerH.indexOf('Allowed:');
        if (idx === -1) continue;
        sp.setAttribute('data-enum-styled', '1');
        sp.innerHTML = innerH.replace(/(<b>)?Allowed:\\s*(<\\/b>)?\\s*([^<]+)/g, function(m, b1, b2, valStr) {
