...
<body>
  ...
  (function() {
    ...
    mqttSheet.replaceSync([
      ...
      ':host { --font-size-small: 15px !important; --font-size-regular: 16px !important; --font-size-mono: 14px !important; }',
      ...
      '.schema-table .td { padding: 8px 12px !important; font-size: 15px !important; word-break: break-word !important; min-width: 0 !important; }',
      '.schema-table .key { min-width: 140px !important; font-size: 15px !important; }',
      '.schema-table .key-type { min-width: 70px !important; white-space: nowrap !important; font-size: 15px !important; }',
      '.schema-table .key-descr { min-width: 0 !important; flex: 1 !important; font-size: 15px !important; }',
      '.obj-descr { font-size: 15px !important; }',
      '.descr-text { font-size: 15px !important; }',
      'span.descr-text { font-size: 15px !important; }',
      '.schema-description { font-size: 15px !important; }',
      '.toolbar-btn { font-size: 14px !important; }',
      '.request-body-container *, .response-body-container * { --font-size-small: 15px !important; --font-size-regular: 16px !important; }',
