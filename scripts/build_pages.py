...
<body>
  ...
  (function() {
    ...
    mqttSheet.replaceSync([
      ...
      /* ── Hide REQUEST BODY label, "default" status, standalone "Response" label ── */
    ...
    function addCopyToElement(root) {
      ...
      for (var r = 0; r < reqResTitles.length; r++) {
        ...
        if (txt.indexOf('REQUEST') !== -1) {
          reqResTitles[r].innerHTML = '<div style="font-size:29px;font-weight:700;color:#003d6b;border-bottom:2px solid #003d6b;padding-bottom:6px;margin-bottom:8px;">Command Payload (Request)</div>' +
          ...
          reqResTitles[r].innerHTML = '<div style="font-size:29px;font-weight:700;color:#003d6b;border-bottom:2px solid #003d6b;padding-bottom:6px;margin-bottom:8px;">Response Payload</div>' +
    ...
    function styleHeadings(root) {
      ...
      for (var t = 0; t < titles.length; t++) {
        ...
        titles[t].style.cssText = 'font-size:42px!important;font-weight:800!important;color:#003d6b!important;letter-spacing:0.3px!important;border-bottom:3px solid #003d6b!important;padding-bottom:10px!important;display:block!important;margin-bottom:16px!important;';
      }
    }
